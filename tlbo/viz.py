"""Vizualizácia pre Teaching-Learning Based Optimization."""
...
def plot_tlbo_search(
    ...
    iter_ids = np.repeat(np.arange(generations), pop_size)
    ...
    ax_surface.set_title("TLBO search on 3D surface", fontsize=11)
    ...
    ax_heat.set_title("TLBO heatmap and trajectories", fontsize=11)
